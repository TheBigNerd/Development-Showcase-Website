...
const Navbar = () => {
    ...
    return(
        <>
            <nav className='z-15 top-4 left-1/2 -translate-x-1/2 absolute hidden md:flex justify-center items-center gap-5 py-2 px-4 md:px-6 rounded-full bg-black/60 backdrop-blur-md border text-white border-zinc-800 w-auto max-w-[95%]'>
            ...
            <nav className='z-15 top-4 left-1/2 -translate-x-1/2 absolute md:hidden flex justify-between items-center py-2 px-4 rounded-full bg-black/60 backdrop-blur-md border text-white border-zinc-800 w-auto max-w-[95%]'>
            ...
            {isMenuOpen && (
                <div className='z-10 top-20 left-1/2 -translate-x-1/2 absolute md:hidden flex flex-col items-center gap-4 py-5 px-6 rounded-xl bg-black/80 backdrop-blur-md border text-white border-zinc-800 w-auto max-w-[95%]'>
